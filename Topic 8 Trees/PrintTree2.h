...
void printTreePrimer (int h, nodeS* head);
...
void printTreeRecur(int h, int clvl, int positionsAvailable, int space, int* arr, nodeS* head)
{
	if (clvl > h)
		return;
...
void printTreePrimer (int h, nodeS* head, int offset)
{
	globalOffset = offset;
